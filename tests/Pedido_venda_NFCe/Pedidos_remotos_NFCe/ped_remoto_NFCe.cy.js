...
test.describe('Remoto/processo 9890 - Regra de saldo Parâmetro 36 = 4 - Parâmetro 139 = 4 - Trial 653 não configurado', () => {
    ...
    context('Pedido de venda remoto normal', () => {
        ...
        test('Ped venda remota: produto 1860 0 0 - (Venda remota de produto com saldo na filial do faturamento )',  async ({ page }) => {
        ...
        test('Ped venda remota: produtos 1860 0 0 e 1870 0 0',  async ({ page }) => {
        ...
        test('Ped venda remota: kit 1877 0 0',  async ({ page }) => {
    ...
    context('Pedido de venda remoto sem saldo remoto, pegar CD', () => {
        ...
        test('Ped venda remoto - com saldo no CD (filial 1) - deve permitir fazer o pedido - (Venda remota de produto (1883 0 0) sem saldo na filial do faturamento, mas com saldo no CD do faturamento - com entrega)',  async ({ page }) => {
        ...
        test('Ped venda remoto - SEM saldo no CD (filial 1) - NÃO deve permitir fazer o pedido - (Venda remota de produto (1882 0 0) sem saldo na filial do faturamento, sem saldo da CD do faturamento)',  async ({ page }) => {
