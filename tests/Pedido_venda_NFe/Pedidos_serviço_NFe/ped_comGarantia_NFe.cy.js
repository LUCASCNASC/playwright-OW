...
test.describe('Gerar pedidos com Garantia', () => {
    ...
    context('Com entrega/processo 9860 - caminho feliz', () => {
        ...
        test('7. Ped venda: produto 1860 0 0 (com Garantia que separa título no mesmo processo)',  async ({ page }) => {
        ...
        test('8. Ped venda: produto 1860 0 0 (com Garantia que separa título no mesmo processo) e produto 1870 0 0 (sem serviço)',  async ({ page }) => {
        ...
        test('9. Ped venda: produto 1860 0 0 (com Garantia que não separa título)',  async ({ page }) => {
        ...
        test('10. Ped venda: produto 1860 0 0 (com Garantia que não separa título) e produto 1870 0 0 (sem serviço)',  async ({ page }) => {
        ...
        test('11. Ped venda: produto 1860 0 0 (com Garantia que separa título em um processo diferente)',  async ({ page }) => {
        ...
        test('12. Ped venda: produto 1860 0 0 (com Garantia que separa título em um processo diferente) e produto 1870 0 0 (sem serviço)',  async ({ page }) => {
